    ...
    <SideBarWrapper>
      <div className="flex flex-col h-full">
        ...
        <div className="flex justify-center mb-4">
          <Link
            href={routes.blog}
            className="flex items-center text-gray-600 group-aria-[checked=false]:px-1 px-4 py-2 transition-colors duration-200 ease-in-out hover:bg-blue-200/30 cursor-pointer"
          >
